...
const DeepfakeDetection = () => {
  ...
  // --- MODIFIED FUNCTION ---
  // This function now simulates an attempt and then shows the error.
  const analyzeMedia = async () => {
    if (!file) return;
    setIsLoading(true);
    setError('');
    ...
    <div className="min-h-screen bg-gray-800 text-white p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-800 border border-[#00ff41] rounded-xl p-8 mb-8">
          ...
          <p className="text-gray-300 mb-8">
            Identifies AI-manipulated or tampered face images and videos using
            advanced convolutional neural networks that analyze pixel-level
            inconsistencies and temporal artifacts.
          </p>
            ...
            {file ? (
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-sm text-gray-500">
                  Supports: JPEG, PNG, MP4, MOV (Max 50MB)
                </p>
              </div>
            )}
          </div>
          ...
          {error && (
            <div className="text-red-400 mb-4 text-center p-3 bg-red-900/20 border border-red-400 rounded-md">
              {error}
            </div>
          )}
        ...
        <div className="bg-gray-800 border border-[#00ff41] rounded-xl p-6">
          <h2 className="text-xl font-semibold mb-4 text-[#00ff41]">
            How It Works
          </h2>
          <ul className="list-disc pl-5 space-y-2 text-gray-300">
            <li>Upload an image or video containing human faces</li>
